...
Route::middleware(['auth', 'user'])->group(function () {
    ...
    Route::post('/user/cart/update/{id}', [CartController::class, 'updateQuantity'])->name('user.cart.update');
...
Route::middleware(['auth', 'organization_admin'])->group(function () {
    ...
    Route::post('/organization/invoices/{id}/status', [OrganizationInvoiceController::class, 'updateStatus'])->name('organization_admin.invoices.updateStatus');
